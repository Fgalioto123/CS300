...
/**
 * Contains testing methods for each method in CartUtilities. Each testing method returns true when
...
public class CartUtilitiesTester {
  ...
  public static boolean testIndexOfItem() {
     ...
     * index then return false because it should always return -1.(I am not sure if this is
     * considered an edge case and if this is wrong and I am still struggling with them on the next
